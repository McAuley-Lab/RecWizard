...
from recwizard.utils import DeviceManager, batchify, pad_and_stack, init_deterministic
...
def parse_args():
    ...
    parser.add_argument(
        "--output_dir", type=str, default="save/unicrs_pre/redial", help="Where to store the final model."
    )
...
if __name__ == "__main__":
    ...
    datasets = datasets.map(
        dp.prepare_data_for_pretrain, batched=True, load_from_cache_file=False, remove_columns=["recNames"]
    )
