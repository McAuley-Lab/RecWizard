"""
This file is adapted from the UniCRS original implementaion: https://github.com/RUCAIBox/UniCRS/blob/master/src/model_gpt2.py
"""
...
class PromptGPT2LMHead(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        if conv:
            ...
            if self.model_parallel:
                ...
                logits = logits.to(self.lm_head.weight.device)
    ...
    @staticmethod
    def _reorder_cache(
        past: Tuple[Tuple[torch.Tensor]], beam_idx: torch.Tensor, **kwargs
    ) -> Tuple[Tuple[Any, ...], ...]:
        return tuple(
