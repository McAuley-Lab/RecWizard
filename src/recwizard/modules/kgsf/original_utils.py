""" This file is adapted from the KGSF original implementation: https://github.com/Lancelot39/KGSF/blob/master/models/utils.py
"""
...
def _create_embeddings(vocab_size, embedding_size, padding_idx, embedding_data=None):
    """Create and initialize word embeddings."""
    e = nn.Embedding(vocab_size, embedding_size, padding_idx)
    if embedding_data is not None:
        e.weight.data.copy_(torch.from_numpy(np.array(embedding_data)))
    else:
