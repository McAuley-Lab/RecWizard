...
class BasePipeline(BaseModule):
    ...
    def __init__(
        ...
        rec_tokenizer: PreTrainedTokenizerBase = None,
        gen_tokenizer: PreTrainedTokenizerBase = None,
        **kwargs,
    ):
        """
    ...
    @monitor
    def response(
        self, query: str, return_dict: bool = False, rec_args: dict = None, gen_args: dict = None, *args, **kwargs
    ):
        r"""
